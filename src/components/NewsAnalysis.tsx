...
const NewsAnalysis = () => {
  ...
  const analyzeNews = async () => {
    ...
    try {
      ...
      let errorMessage = "Failed to analyze news. Please check if the backend server is running or try again later.";
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-card border-border">
                <CardHeader>
                  ...
                  <CardDescription className="text-muted-foreground">Top 5 news articles from Alpha Vantage</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
